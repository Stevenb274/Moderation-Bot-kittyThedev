...
module.exports = {
  ...
  run: async (client, message, args) => {
    ...
    if (args[0] === message.guild.owner.user.id)
      return message.channel.send(`Server Owner Is Already Unbanned!. Why You Should ban him?`);

    if (args[0] === client.user.id)
      return message.channel.send(`I Am Already Unbanned, What Do You think.!`);
    ...
    try {
      ...
      return message.channel.send(
        `I Can't Unban That Member Maybe Member Is Not Banned Or Some Error Happened!`
      );
    }
