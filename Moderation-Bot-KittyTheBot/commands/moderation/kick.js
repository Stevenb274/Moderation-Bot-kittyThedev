...
module.exports = {
  ...
  run: async (client, message, args) => {
    ...
    if (Member.id === message.author.id)
      return message.channel.send(`You Can't Kick Yourself!._.`);

    if (Member.id === client.user.id)
      return message.channel.send(`Please Dont Kick Me :( ,im a nice cat`);
    ...
    try {
      console.log(`User Is Going To Get Kick!`);
